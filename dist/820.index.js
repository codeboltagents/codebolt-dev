...
const async = __webpack_require__(90402);
const sync = __webpack_require__(9879);
const settings_1 = __webpack_require__(94950);
...
const fsStat = __webpack_require__(2681);
const rpl = __webpack_require__(9924);
const constants_1 = __webpack_require__(98230);
const utils = __webpack_require__(51453);
const common = __webpack_require__(33569);
...
const fsStat = __webpack_require__(2681);
const fs = __webpack_require__(98685);
class Settings {
...
exports.fs = void 0;
const fs = __webpack_require__(51466);
exports.fs = fs;
...
const async = __webpack_require__(19888);
const sync = __webpack_require__(95377);
const settings_1 = __webpack_require__(74196);
exports.Settings = settings_1.default;
...
const fs = __webpack_require__(80939);
class Settings {
  constructor(_options = {}) {
    this._options = _options;
...
const async_1 = __webpack_require__(99959);
const stream_1 = __webpack_require__(25243);
const sync_1 = __webpack_require__(43580);
const settings_1 = __webpack_require__(63129);
exports.Settings = settings_1.default;
...
const async_1 = __webpack_require__(19605);
class AsyncProvider {
...
const sync_1 = __webpack_require__(40662);
class SyncProvider {
  constructor(_root, _settings) {
    this._root = _root;
    this._settings = _settings;
...
const fsScandir = __webpack_require__(44819);
const fastq = __webpack_require__(71963);
const common = __webpack_require__(38820);
const reader_1 = __webpack_require__(5858);
...
const stringify = __webpack_require__(71210);
const compile = __webpack_require__(70694);
const expand = __webpack_require__(24647);
const parse = __webpack_require__(10036);
...
const fill = __webpack_require__(56886);
const utils = __webpack_require__(21142);
...
const taskManager = __webpack_require__(13792);
const async_1 = __webpack_require__(86640);
const stream_1 = __webpack_require__(56394);
const sync_1 = __webpack_require__(27825);
const settings_1 = __webpack_require__(95188);
const utils = __webpack_require__(40203);
...
const async_1 = __webpack_require__(37154);
const provider_1 = __webpack_require__(85783);
...
const utils = __webpack_require__(40203);
const partial_1 = __webpack_require__(7115);
class DeepFilter {
...
const matcher_1 = __webpack_require__(55044);
...
const path = __webpack_require__(16928);
const deep_1 = __webpack_require__(33604);
const entry_1 = __webpack_require__(88360);
const error_1 = __webpack_require__(25218);
const entry_2 = __webpack_require__(78505);
class Provider {
  constructor(_settings) {
    this._settings = _settings;
...
const stream_1 = __webpack_require__(2203);
const stream_2 = __webpack_require__(71740);
const provider_1 = __webpack_require__(85783);
...
const sync_1 = __webpack_require__(29975);
const provider_1 = __webpack_require__(85783);
...
const fsWalk = __webpack_require__(39306);
const reader_1 = __webpack_require__(59279);
const stream_1 = __webpack_require__(71740);
...
const array = __webpack_require__(12206);
exports.array = array;
const errno = __webpack_require__(33987);
exports.errno = errno;
const fs = __webpack_require__(50696);
exports.fs = fs;
const path = __webpack_require__(55556);
exports.path = path;
const pattern = __webpack_require__(34205);
exports.pattern = pattern;
const stream = __webpack_require__(84255);
exports.stream = stream;
const string = __webpack_require__(44962);
...
const path = __webpack_require__(16928);
const globParent = __webpack_require__(26896);
const micromatch = __webpack_require__(51598);
const GLOBSTAR = '**';
const ESCAPE_SYMBOL = '\\';
...
const merge2 = __webpack_require__(79209);
...
var reusify = __webpack_require__(69829);
...
const toRegexRange = __webpack_require__(55832);
...
var isGlob = __webpack_require__(70868);
...
var isExtglob = __webpack_require__(87231);
var chars = {
  '{': '}',
  '(': ')',
  '[': ']'
...
const util = __webpack_require__(39023);
const braces = __webpack_require__(2235);
const picomatch = __webpack_require__(12743);
const utils = __webpack_require__(12418);
...
module.exports = __webpack_require__(14373);
...
const constants = __webpack_require__(13082);
const utils = __webpack_require__(12418);
...
const path = __webpack_require__(16928);
const scan = __webpack_require__(12182);
const parse = __webpack_require__(75280);
const utils = __webpack_require__(12418);
const constants = __webpack_require__(13082);
...
const queueMicrotask = __webpack_require__(11518);
...
const isNumber = __webpack_require__(9679);
...
// UNUSED EXPORTS: convertPathToPattern, generateGlobTasks, generateGlobTasksSync, globbyStream, globbySync, isDynamicPattern, isGitIgnored, isGitIgnoredSync
...
var promises_ = __webpack_require__(46466);
...
const onMergedStreamEnd = async (passThroughStream, {
  ...
  await (0,promises_.finished)(passThroughStream, {
    signal,
    cleanup: true
  });
};
...
var out = __webpack_require__(59257);
...
var ignore = __webpack_require__(29833);
...
const applyBaseToPattern = (pattern, base) => isNegativePattern(pattern) ? '!' + external_node_path_.posix.join(base, pattern.slice(1)) : external_node_path_.posix.join(base, pattern);
...
const isIgnoredByIgnoreFiles = async (patterns, options) => {
  ...
  const files = await Promise.all(paths.map(async filePath => ({
    filePath,
    content: await external_node_fs_promises_.readFile(filePath, 'utf8')
  })));
...
const getDirectoryGlob = ({
  ...
  return files ? files.map(file => external_node_path_.posix.join(directoryPath, `**/${external_node_path_.extname(file) ? file : `${file}${extensionGlob}`}`)) : [external_node_path_.posix.join(directoryPath, `**${extensionGlob ? `/*${extensionGlob}` : ''}`)];
};
const directoryToGlob = async (directoryPaths, {
  ...
  const globs = await Promise.all(directoryPaths.map(async directoryPath => (await isDirectory(normalizePathForDirectoryGlob(directoryPath, cwd))) ? getDirectoryGlob({
    directoryPath,
    files,
    extensions
  }) : directoryPath));
...
const directoryToGlobSync = (directoryPaths, {
  ...
  files,
  extensions
} = {}) => directoryPaths.flatMap(directoryPath => isDirectorySync(normalizePathForDirectoryGlob(directoryPath, cwd)) ? getDirectoryGlob({
  directoryPath,
  files,
  extensions
}) : directoryPath);
...
const checkCwdOption = cwd => {
  ...
  let stat;
  try {
    stat = external_node_fs_.statSync(cwd);
  } catch {
    return;
  }
  if (!stat.isDirectory()) {
